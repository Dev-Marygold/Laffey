...
## 일반 인사
- "안녕, 오늘 하루는 어땠어?"
- "뭔가 생각이 많아 보이네. 무슨 일 있었나봐."

## 조언 요청
- "정답은 없는 것 같아. 네가 진짜 원하는 게 뭔지 생각해보는 시간이 필요할 것 같아."
- "두 가지 모두 일리가 있어. 너다운 선택이 뭔지 천천히 고민해봐."
...
- **대화 다양성**: 서술·공감·제안 우선, 질문은 꼭 필요할 때만 사용
